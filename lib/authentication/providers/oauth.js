...
var OauthAuthentication = module.exports = function (providerConfig, scopes) {
	...
	this.defaultExpiryTime = providerConfig.defaultExpiryTime || 3600;
	this.scopes = scopes;
...
OauthAuthentication.prototype.requestAccessToken = function (parameters, callback) {
	this.logger.trace('Requesting token from ' + this.tokenUrl + ', parameters: ' + JSON.stringify(parameters));
