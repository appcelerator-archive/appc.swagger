 ...
 * @returns {*}
 */
function loadModels(APIBuilder, connector, options, logger, callback) {
	// Configure our model load.
	var params = {
			APIBuilder: APIBuilder,
			connector: connector,
			models: {},
			logger: logger || require('apibuilder').createLogger({}, { name: 'appc.swagger', useConsole: true, level: 'debug' }),
			options: options
		},
		tasks = [];
